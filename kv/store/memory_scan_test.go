...
// mustScanKeysStore scans keys from the store and panics if it fails.
func mustScanKeysStore(t *testing.T, store Store, prefix, after string, limit int64) *KeyScanPage {
	t.Helper()
